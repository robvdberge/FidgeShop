<?php
include_once $_SERVER['DOCUMENT_ROOT'].'/Fidgetshopnlx/lib/Database.php';
include_once $_SERVER['DOCUMENT_ROOT'].'/Fidgetshopnlx/lib/Format.php';

// categorie
//       id ,   cat_naam , cat_omschrijving , url 
